VERSION := 0.0.1-SNAPSHOT # $(shell mvn help:evaluate -Dexpression=project.version -q -DforceStdout)
...
run-all: build
	@DOCKER_CONTAINER_IMAGE=$(DOCKER_CONTAINER_IMAGE) docker-compose up -d
